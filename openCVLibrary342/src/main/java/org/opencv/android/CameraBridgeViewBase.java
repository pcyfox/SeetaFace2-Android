...
//                    Log.d(TAG, "mStretch value: " + mScale);
                ...
                if (mScale != 0) {
                    canvas.drawBitmap(mCacheBitmap, new Rect(0, 0, w, h),
                            new Rect((int) ((canvas.getWidth() - mScale * w) / 2),
                                    (int) ((canvas.getHeight() - mScale * h) / 2),
                                    (int) ((canvas.getWidth() - mScale * w) / 2 + mScale * w),
                                    (int) ((canvas.getHeight() - mScale * h) / 2 + mScale * h)), null);
                } else {
                    canvas.drawBitmap(mCacheBitmap, new Rect(0, 0, w, h),
                            new Rect((canvas.getWidth() - w) / 2,
                                    (canvas.getHeight() - h) / 2,
                                    (canvas.getWidth() - w) / 2 + w,
                                    (canvas.getHeight() - h) / 2 + h), null);
                }
