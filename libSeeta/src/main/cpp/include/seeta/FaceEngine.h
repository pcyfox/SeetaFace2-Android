...
namespace seeta {
    ...
    public:
        ...
        FaceEngine(const SeetaModelSetting &FD_model, const SeetaModelSetting &PD_model,
        ...
        std::vector<SeetaPointF>
        DetectPoints(const SeetaImageData &image, const SeetaRect &face) const {
        ...
        std::vector<SeetaPointF>
        DetectPoints(const SeetaImageData &image, const SeetaFaceInfo &face) const {
        ...
        size_t
        QueryTop(const SeetaImageData &image, size_t N, int64_t *index, float *similarity) const {
            auto faces = this->DetectFaces(image);
            if (faces.empty()) return -1;
        ...
        size_t
        QueryTop(const SeetaImageData &image, const SeetaFaceInfo &face, size_t N, int64_t *index,
                 float *similarity) const {
            return this->QueryTop(image, face.pos, N, index, similarity);
        }

        size_t
        QueryTop(const SeetaImageData &image, const SeetaRect &face, size_t N, int64_t *index,
                 float *similarity) const {
            auto points = this->DetectPoints(image, face);
        ...
        size_t
        QueryTop(const SeetaImageData &image, const SeetaPointF *points, size_t N, int64_t *index,
                 float *similarity) const {
